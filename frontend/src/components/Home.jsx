...
const Hero = () => {
  ...
  const colors = ["#3B82F6", "#8B5CF6", "#EF4444", "#10B981", "#6366F1"]; // Tailwind Hex Colors
  ...
  return (
    <section 
      className="relative h-[500px] flex items-center justify-center text-white text-center transition-all duration-1000"
      style={{ backgroundColor: colors[currentIndex] }} // ✅ Background color changes dynamically
    >
      ...
      <div className="z-10 relative">
        ...
        <p className="mt-4 text-lg">Discover more about us, our team, and how to contact us.</p>
        <a href="#about" className="mt-6 inline-block bg-white text-blue-600 hover:bg-gray-300 px-6 py-2 rounded-full text-lg font-semibold transition-colors duration-300">
          Learn More
        </a>
      </div>
    </section>
